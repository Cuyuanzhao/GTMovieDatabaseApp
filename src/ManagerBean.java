...
public class ManagerBean {
    ...
    public boolean isValid(User c) {
        ...
        try {
            String sql = "SELECT * FROM MANAGER WHERE Username = '" + c.getUsername() + "' AND Passwords = '" + c.getPassword() + "'";
    ...
    public boolean isAvailable(User c) {
        boolean result = false;
        try {
            String sql = "SELECT * FROM MANAGER WHERE Username = '" + c.getUsername() + "' OR Email = '" + c.getEmail() + "'" ;
            Global.jrs.setCommand(sql);
            Global.jrs.execute();
            if (!Global.jrs.next()) {
                result = true;
    ...
    public String insert(User c) {
        ...
        try {
            ...
            Global.jrs.execute();
            if (Global.jrs.next()) {
                errorMsg = "The Username or Email is not available";
            }
            else {
